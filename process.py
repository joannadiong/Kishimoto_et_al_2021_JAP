...
def plot_signals(subjects):
    ...
    ax1.set_ylabel('EMG SO [V]')
    ax2.set_ylabel('EMG SO [ln(V)]')
    ax3.set_ylabel('EMG MG [V]')
    ax4.set_ylabel('EMG MG [ln(V)]')
    ax5.set_ylabel('EMG LG [V]')
    ax5.set_xlabel('Activation [%]')
    ax6.set_ylabel('EMG LG [ln(V)]')
    ...
    ax1.set_ylabel('EMG SO [V]')
    ax2.set_ylabel('EMG MG [V]')
    ax3.set_ylabel('EMG LG [V]')
